...
export function getCONF(host) {
  ...
  host.indexOf('wx2.qq.com') > -1 ? (loginUrl = 'login.wx2.qq.com', fileUrl = 'file.wx2.qq.com', pushUrl = 'webpush.wx2.qq.com') : host.indexOf('wx8.qq.com') > -1 ? (loginUrl = 'login.wx8.qq.com', fileUrl = 'file.wx8.qq.com', pushUrl = 'webpush.wx8.qq.com') : host.indexOf('qq.com') > -1 ? (loginUrl = 'login.wx.qq.com', fileUrl = 'file.wx.qq.com', pushUrl = 'webpush.wx.qq.com') : host.indexOf('web2.wechat.com') > -1 ? (loginUrl = 'login.web2.wechat.com', fileUrl = 'file.web2.wechat.com', pushUrl = 'webpush.web2.wechat.com') : host.indexOf('wechat.com') > -1 && (loginUrl = 'login.web.wechat.com', fileUrl = 'file.web.wechat.com', pushUrl = 'webpush.web.wechat.com');
