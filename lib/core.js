  ...
  _createClass(WechatCore, [{
    ...
    value: function checkLogin() {
      ...
      return Promise.resolve().then(function () {
        var params = {
          'tip': 0,
          'uuid': _this2.PROP.uuid,
          'loginicon': true
        };
        return _this2.request({
          method: 'GET',
          url: _this2.CONF.API_login,
          params: params
        }).then(function (res) {
          var window = {};
          ...
          if (window.code === 200) {
            _this2.CONF = (0, _util.getCONF)(window.redirect_uri.match(/(?:\w+\.)+\w+/)[0]);
            _this2.rediUri = window.redirect_uri;
    ...
    value: function login() {
      ...
      return Promise.resolve().then(function () {
        return _this3.request({
          ...
          if (pm && pm[1] === '0') {
            _this3.PROP.skey = res.data.match(/<skey>(.*)<\/skey>/)[1];
            _this3.PROP.sid = res.data.match(/<wxsid>(.*)<\/wxsid>/)[1];
            _this3.PROP.uin = res.data.match(/<wxuin>(.*)<\/wxuin>/)[1];
            _this3.PROP.passTicket = res.data.match(/<pass_ticket>(.*)<\/pass_ticket>/)[1];
          }
          if (res.headers['set-cookie']) {
            res.headers['set-cookie'].forEach(function (item) {
              if (/webwx.*?data.*?ticket/i.test(item)) {
                _this3.PROP.webwxDataTicket = item.match(/=(.*?);/)[1];
              } else if (/wxuin/i.test(item)) {
                _this3.PROP.uin = item.match(/=(.*?);/)[1];
              } else if (/wxsid/i.test(item)) {
                _this3.PROP.sid = item.match(/=(.*?);/)[1];
              }
            });
          }
        });
    ...
    value: function init() {
      ...
      return Promise.resolve().then(function () {
        var params = {
          'pass_ticket': _this4.PROP.passTicket,
          'skey': _this4.PROP.skey,
          'r': ~new Date()
        };
        var data = {
          BaseRequest: _this4.getBaseRequest()
        };
        return _this4.request({
          method: 'POST',
          url: _this4.CONF.API_webwxinit,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
          _util.assert.equal(data.BaseResponse.Ret, 0, res);
          _this4.PROP.skey = data.SKey || _this4.PROP.skey;
          _this4.updateSyncKey(data);
          Object.assign(_this4.user, data.User);
          return data;
        });
      }).catch(function (err) {
        debug(err);
    ...
    value: function notifyMobile(to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Code': to ? 1 : 3,
          'FromUserName': _this5.user['UserName'],
          'ToUserName': to || _this5.user['UserName'],
          'ClientMsgId': (0, _util.getClientMsgId)()
        };
        return _this5.request({
          method: 'POST',
          url: _this5.CONF.API_webwxstatusnotify,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function getContact() {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this6.request({
          method: 'POST',
          url: _this6.CONF.API_webwxgetcontact,
          params: params
        }).then(function (res) {
          var data = res.data;
          _util.assert.equal(data.BaseResponse.Ret, 0, res);
    ...
    value: function batchGetContact(contacts) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this7.request({
          method: 'POST',
          url: _this7.CONF.API_webwxbatchgetcontact,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function statReport(text) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this8.request({
          method: 'POST',
          url: _this8.CONF.API_webwxreport,
          params: params,
          data: data
        });
      }).catch(function (err) {
    ...
    value: function sync() {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'SyncKey': _this10.PROP.syncKey,
          'rr': ~new Date()
        };
        return _this10.request({
          method: 'POST',
          url: _this10.CONF.API_webwxsync,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
          ...
          _this10.updateSyncKey(data);
          _this10.PROP.skey = data.SKey || _this10.PROP.skey;
          return data;
        });
      }).catch(function (err) {
        debug(err);
    ...
    value: function logout() {
      ...
      return Promise.resolve().then(function () {
        var params = {
          ...
          method: 'POST',
          url: _this11.CONF.API_webwxlogout,
          params: params
        }).then(function (res) {
          return '登出成功';
        }).catch(function (err) {
    ...
    value: function sendText(msg, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Scene': 0,
          'Msg': {
            'Type': _this12.CONF.MSGTYPE_TEXT,
            'Content': msg,
            'FromUserName': _this12.user['UserName'],
            'ToUserName': to,
            'LocalID': clientMsgId,
        ...
        return _this12.request({
          method: 'POST',
          url: _this12.CONF.API_webwxsendmsg,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function sendEmoticon(id, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Scene': 0,
          'Msg': {
            'Type': _this13.CONF.MSGTYPE_EMOTICON,
            'EmojiFlag': 2,
        ...
        return _this13.request({
          method: 'POST',
          url: _this13.CONF.API_webwxsendemoticon,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
      ...
      return Promise.resolve().then(function () {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var uploadMediaRequest = JSON.stringify({
            ...
            ToUserName: toUserName || _this14.user.UserName
          });
          ...
          form.append('webwx_data_ticket', _this14.PROP.webwxDataTicket);
          form.append('pass_ticket', encodeURI(_this14.PROP.passTicket));
          ...
          return _this14.request({
            method: 'POST',
            url: _this14.CONF.API_webwxuploadmedia,
    ...
    value: function sendPic(mediaId, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Scene': 0,
          'Msg': {
            'Type': _this15.CONF.MSGTYPE_IMAGE,
            'MediaId': mediaId,
        ...
        return _this15.request({
          method: 'POST',
          url: _this15.CONF.API_webwxsendmsgimg,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function sendVideo(mediaId, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Scene': 0,
          'Msg': {
            'Type': _this16.CONF.MSGTYPE_VIDEO,
            'MediaId': mediaId,
        ...
        return _this16.request({
          method: 'POST',
          url: _this16.CONF.API_webwxsendmsgvedio,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function sendDoc(mediaId, name, size, ext, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          ...
          'Scene': 0,
          'Msg': {
            'Type': _this17.CONF.APPMSGTYPE_ATTACH,
        ...
        return _this17.request({
          method: 'POST',
          url: _this17.CONF.API_webwxsendappmsg,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function forwardMsg(msg, to) {
      ...
      return Promise.resolve().then(function () {
        ...
        var url = void 0,
            pm = void 0;
        switch (msg.MsgType) {
          case _this18.CONF.MSGTYPE_TEXT:
            url = _this18.CONF.API_webwxsendmsg;
            if (msg.SubMsgType === _this18.CONF.MSGTYPE_LOCATION) {
              data.Msg.Type = _this18.CONF.MSGTYPE_LOCATION;
              data.Msg.Content = msg.OriContent.replace(/&lt;/g, '<').replace(/&gt;/g, '>');
            }
            break;
          case _this18.CONF.MSGTYPE_IMAGE:
            url = _this18.CONF.API_webwxsendmsgimg;
            break;
          case _this18.CONF.MSGTYPE_EMOTICON:
            url = _this18.CONF.API_webwxsendemoticon;
            params.fun = 'sys';
            ...
            break;
          case _this18.CONF.MSGTYPE_MICROVIDEO:
          case _this18.CONF.MSGTYPE_VIDEO:
            url = _this18.CONF.API_webwxsendmsgvedio;
            data.Msg.Type = _this18.CONF.MSGTYPE_VIDEO;
            break;
          case _this18.CONF.MSGTYPE_APP:
    ...
    value: function getMsgImg(msgId) {
      ...
      return Promise.resolve().then(function () {
        var params = {
          MsgID: msgId,
          skey: _this19.PROP.skey,
          type: 'big'
        };

        return _this19.request({
          method: 'GET',
          url: _this19.CONF.API_webwxgetmsgimg,
          params: params,
    ...
    value: function getVideo(msgId) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this20.request({
          method: 'GET',
          url: _this20.CONF.API_webwxgetvideo,
          headers: {
            'Range': 'bytes=0-'
          },
          params: params,
    ...
    value: function getVoice(msgId) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this21.request({
          method: 'GET',
          url: _this21.CONF.API_webwxgetvoice,
          params: params,
          responseType: 'arraybuffer'
        }).then(function (res) {
          return {
    ...
    value: function getHeadImg(HeadImgUrl) {
      ...
      return Promise.resolve().then(function () {
        var url = _this22.CONF.origin + HeadImgUrl;
    ...
    value: function getDoc(FromUserName, MediaId, FileName) {
      ...
      return Promise.resolve().then(function () {
        var params = {
          ...
          mediaid: MediaId,
          filename: FileName,
          fromuser: _this23.user.UserName,
          pass_ticket: _this23.PROP.passTicket,
          webwx_data_ticket: _this23.PROP.webwxDataTicket
        };
        return _this23.request({
          method: 'GET',
          url: _this23.CONF.API_webwxdownloadmedia,
          params: params,
          responseType: 'arraybuffer'
        }).then(function (res) {
          return {
    ...
    value: function verifyUser(UserName, Ticket) {
      ...
      return Promise.resolve().then(function () {
        ...
        var data = {
          'BaseRequest': _this24.getBaseRequest(),
          'Opcode': 3,
          ...
          'SceneListCount': 1,
          'SceneList': [33],
          'skey': _this24.PROP.skey
        };
        return _this24.request({
          method: 'POST',
          url: _this24.CONF.API_webwxverifyuser,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function createChatroom(Topic, MemberList) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this25.request({
          method: 'POST',
          url: _this25.CONF.API_webwxcreatechatroom,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function updateChatroom(ChatRoomUserName, MemberList, fun) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this26.request({
          method: 'POST',
          url: _this26.CONF.API_webwxupdatechatroom,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function opLog(UserName, OP, RemarkName) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this27.request({
          method: 'POST',
          url: _this27.CONF.API_webwxoplog,
          params: params,
          data: data
        }).then(function (res) {
          var data = res.data;
    ...
    value: function updateChatRoomName(ChatRoomUserName, NewName) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this29.request({
          method: 'POST',
          url: _this29.CONF.API_webwxupdatechatroom,
          params: params,
          data: data
        }).then(function (res) {
    ...
    value: function revokeMsg(msgId, toUserName) {
      ...
      return Promise.resolve().then(function () {
        ...
        return _this30.request({
          method: 'POST',
          url: _this30.CONF.API_webwxrevokemsg,
          data: data
        }).then(function (res) {
          var data = res.data;
          _util.assert.equal(data.BaseResponse.Ret, 0, res);
    ...
    set: function set(data) {
      ...
      Object.keys(data).forEach(function (key) {
        Object.assign(_this31[key], data[key]);
      });
    }
  }]);
